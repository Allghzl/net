      ...
      <div className="w-full h-[500px] md:h-[600px] relative overflow-hidden">
        ...
        <div className="max-w-xl text-left">
          ...
          <p className="text-white text-lg">
            mengisahkan Don, seorang anak laki-laki yang sering merasa rendah diri karena tubuhnya yang besar dan kerap diremehkan oleh teman-temannya.
          </p>
...
const Home = () => (
  <div className="bg-[#141414] min-h-screen text-white">
    ...
    <div className="px-8 py-6">
      ...
      <MediaCarousel
        title="Horror"
      items={dummyData.horror.map((item) => ({
          title: "",
          thumbnail: item.thumbnail,
        }))}
      />
