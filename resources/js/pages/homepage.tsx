                ...
                <div className="flex grow justify-end px-2">
                    <div className="flex items-stretch">
                        <div className="dropdown dropdown-start bg-transparent mr-3">
                            <div className="h-8 outline-1 bg-zinc-950/30 outline-white/50 rounded-xs flex items-center gap-1 px-2 cursor-pointer">
                                <Languages className="w-4 h-4 text-white" />
                                <div tabIndex={0} role="button" className="btn btn-ghost font-medium hover:bg-transparent focus:bg-transparent rounded-field border-none shadow-none">Bahasa Indonesia</div>
                        ...
                        <a href={route('plan')} className="h-8 btn btn-ghost font-poppins bg-sky-600 rounded-field shadow-none border-none hover:bg-sky-700 focus:bg-sky-700">Masuk</a>
                    </div>
                </div>
            </Header>
